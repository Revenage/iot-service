...
var $author$project$Types$Unauthorised = {$: 'Unauthorised'};
var $author$project$Main$HandleCheckMeResponse = function (a) {
	return {$: 'HandleCheckMeResponse', a: a};
};
...
var $author$project$Types$Me = F3(
	function (id, username, email) {
		return {email: email, id: id, username: username};
	});
var $author$project$Decoders$decodeMe = A4(
	$elm$json$Json$Decode$map3,
	$author$project$Types$Me,
...
var $author$project$Main$checkMe = function (data) {
	var _v0 = data;
	var token = _v0.token;
	var config = _v0.config;
	return (!$elm$core$String$length(token)) ? A2(
		$elm$core$Task$perform,
		$elm$core$Basics$identity,
		$elm$core$Task$succeed($author$project$Main$Logout)) : $elm$http$Http$request(
		{
			body: $elm$http$Http$emptyBody,
			expect: A2($elm$http$Http$expectJson, $author$project$Main$HandleCheckMeResponse, $author$project$Decoders$decodeMe),
...
var $author$project$Router$toRoute = function (string) {
	var _v0 = string.path;
	if (_v0 === '') {
	...
	function (initialData, url, key) {
		...
		return _Utils_Tuple2(
			...
			$elm$core$Platform$Cmd$batch(
				_List_fromArray(
					[
						$author$project$Main$checkMe(initialData),
...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			case 'MsgLogin':
				var subN = msg.a;
				var _v1 = A2($author$project$Pages$Login$update, subN, model.login);
				...
				if (result.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								route: $author$project$Router$toPublicRoute(model.route),
								session: $author$project$Types$Unauthorised
							}),
						$elm$core$Platform$Cmd$none);
				}
...
var $author$project$Pages$Dashboard$Model = function (translation) {
	return {translation: translation};
};
var $author$project$Pages$Guest$Model = function (translation) {
	return {translation: translation};
};
...
var $author$project$Main$MsgDashboard = function (a) {
	return {$: 'MsgDashboard', a: a};
};
var $author$project$Main$MsgGuest = function (a) {
	return {$: 'MsgGuest', a: a};
};
...
var $author$project$Pages$Guest$view = function (model) {
	var trans = $author$project$Services$I18n$get(model.translation);
	return {
		body: _List_fromArray(
			[
	...
	switch (_v0.$) {
		...
		case 'TranslateSuccess':
			var viewPage = function (pageview) {
				var _v7 = pageview(model);
				var title = _v7.title;
				var content = _v7.content;
				return {
					body: _List_fromArray(
						[
			...
			switch (_v1.$) {
				case 'Guest':
					var _v2 = $author$project$Pages$Guest$view(
						$author$project$Pages$Guest$Model(model.translation));
					var title = _v2.title;
					var body = _v2.body;
					return {
						body: A2(
							$elm$core$List$map,
							$elm$html$Html$map($author$project$Main$MsgGuest),
							body),
						title: title
					};
				case 'Dashboard':
					var _v3 = $author$project$Pages$Dashboard$view(
						$author$project$Pages$Dashboard$Model(model.translation));
					var title = _v3.title;
					var body = _v3.body;
					return {
						body: A2(
							$elm$core$List$map,
							$elm$html$Html$map($author$project$Main$MsgDashboard),
							body),
						title: title
					};
				case 'Login':
					var _v4 = $author$project$Pages$Login$view(model.login);
					var title = _v4.title;
					var body = _v4.body;
					return {
						body: A2(
				...
				case 'SignUp':
					var _v5 = $author$project$Pages$SignUp$view(
				...
				default:
					var _v6 = $author$project$Pages$NotFound$view(
						...
						function (host) {
							return A2(
								...
								function (defaultLanguage) {
									return $elm$json$Json$Decode$succeed(
										{defaultLanguage: defaultLanguage, host: host});
								},
...
},{}]},{},["../../../../../.config/yarn/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","App/index.js"], null)
//# sourceMappingURL=/App.67260ac9.js.map